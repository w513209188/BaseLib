...
public class BjyBackPlayDownManager {
    ...
    public void startDown(PlayDownConfig playDownBean) throws Exception {
        ...
        getDownloadManager().downloadRoomPackage(playDownBean.getFileName(), playDownBean.getVideoId(),
    ...
    public PlaybackDownloader getDownloadManager(){
...
//        return manager;
    ...
    public void deleteAllVideo(final List<DownloadTask> downloadTaskList, final VideoDeleteCall mCall){
        Observable.create(new Observable.OnSubscribe<Boolean>() {
            ...
            public void call(Subscriber<? super Boolean> subscriber) {
                for(DownloadTask downloadTask:downloadTaskList){
                    getDownloadManager().getManager().deleteTask(downloadTask);
                }
    ...
    public String getPlayBackSig(long rooid, long sessId){
        return  getDownloadManager().getManager().getTaskByRoom(rooid,sessId).getSignalFileName();
